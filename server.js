...
app.get('/api/health', (req, res) => {
  res.json({
    status: 'ok',
    project: 'Restaurant Ordering and Management System',
    author: 'Sree Balasubramaniyan (24BKT0162)',
...
const startServer = async () => {
  try {
    ...
    if (restCount === 0) {
      console.log('[Server] Database is empty. Automatically running initial seeding...');
      // Re-use connection to seed
      ...
      console.log('[Server] 60+ sample documents seeded automatically.');
    }

    app.listen(PORT, () => {
      console.log('========================================================');
      console.log(` SERVER RUNNING: http://localhost:${PORT}`);
      console.log(` Student: Sree Balasubramaniyan (24BKT0162) - VIT Vellore`);
      console.log(` Project: Restaurant Ordering and Management System`);
